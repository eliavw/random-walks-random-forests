...
def main(config_fname, fold):
    ...
    if io_config['load']:
        ...
        model, ind_time = induction(train_data, vsd_config)
...
def inference_and_evaluation(model,
    ...
    data_tuple = tuple([0] + [0.75] * len(eval_kinds))
