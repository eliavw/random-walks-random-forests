...
class RunPxLParallel(RunPxL):

    def __init__(self, **kwargs):
        super(RunPxLParallel, self).__init__(**kwargs)
        self.script = 'run_PxL_parallel'
        return
    ...
    def default_config(self, **kwargs):
        ...
        super(RunPxLParallel, self).default_config(**kwargs)
        return
    ...
    def _default_io_config_file(self, dirs=None):
        d = super(RunPxLParallel, self)._default_io_config_file(dirs=dirs)
        nb_queries = self.config['nb_queries']
