...
class RunPxS(Runner):
    ...
    def __init__(self, **kwargs):
        ...
        init_kwargs = filter_kwargs_function(super(RunPxS, self).__init__,
                                             **kwargs)
        super(RunPxS, self).__init__(script='run_PxS', **init_kwargs)
    ...
    def update_config(self, **kwargs):
        ...
        for kind in {child, 'eval'}:
            super(RunPxS, self).update_config(kind=kind,
                                              hierarchical=False,
                                              overwrite=False,
                                              **kwargs)
        ...
        # Update config RunMercs
        super(RunPxS, self).update_config(hierarchical=True,
                                          **kwargs)
    ...
    def default_io_config(self, root_dir=None, dataset=None, idx=None):
        ...
        # io-dirs
        d = super(RunPxS, self).default_io_config_dirs(root_dir=root_dir,
                                                       dataset=dataset,
                                                       idx=idx)
