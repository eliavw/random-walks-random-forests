...
class RunMercs(Runner):

    def __init__(self, **kwargs):

        init_kwargs = filter_kwargs_function(super(RunMercs, self).__init__,
                                             **kwargs)
        super(RunMercs, self).__init__(script='run_mercs', **init_kwargs)
    ...
    def update_config(self, **kwargs):
        ...
        for kind in {child, 'eval'}:
            super(RunMercs, self).update_config(kind=kind,
                                                hierarchical=False,
                                                overwrite=False,
                                                **kwargs)
        ...
        super(RunMercs, self).update_config(hierarchical=True,
                                            **kwargs)
    ...
    def save_config(self, overwrite=True):
        ...
        super(RunMercs, self).save_config()
        return
    ...
    def default_io_config(self, root_dir=None, dataset=None, idx=None):
        ...
        # io-dirs
        d = super(RunMercs, self).default_io_config_dirs(root_dir=root_dir,
                                                         dataset=dataset,
                                                         idx=idx)
